...
namespace HyperV
{
    ...
    public class Grass : BasicPrimitive
    {
        ...
        public Grass(Game game, float initialScale, Vector3 initialRotation, Vector3 initialPosition, Vector2 span, string nomTileTexture, Vector2 numbers, float updateInterval) : base(game, initialScale, initialRotation, initialPosition)
        {
