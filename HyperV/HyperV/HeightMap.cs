                   ...
                   initialPosition)
      {
        ...
        public float GetHeight(Vector3 positionReceived)
        {
            ...
            if (i >= 0 && j >= 0 && i + 1 < /*Heights.GetLength(0)*/VerticesPts.GetLength(0) && j + 1 < VerticesPts.GetLength(1)/*Heights.GetLength(1)*/)
            {
                ...
                height = (n.X * VerticesPts[i, j].X + n.Y * VerticesPts[i, j].Y + n.Z * VerticesPts[i, j].Z - n.X * position.X - n.Z * position.Z) / n.Y + 5 + InitialPosition.Y; // - InitialPosition.Y is new !!!
                //height = Heights[i, j];
            }
            else
            {
