...
namespace HyperV
{
    public class HyperVGame : Microsoft.Xna.Framework.GameComponent
    {
        ...
        {
            Game.Components.Add(new TexturedCube(Game, 1f, Vector3.Zero, new Vector3(0, 0, 0), "CielBlue", Vector3.One, STANDARD_UPDATE_INTERVAL));
        }
